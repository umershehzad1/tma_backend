...
o.update = async (req, res) => {
    ...
    try {
        ...
        (req.body.discountDate) ?  properties["discountDate"]  = req.body.discountDate  : "";
        ...
        (req.body.description)  ?  properties["description"]   = req.body.description   : "";
        (req.body.featuredImage)?  properties["featuredImage"] = req.body.featuredImage : "";
        ...
        const updatedProduct = await Product.findOneAndUpdate({_id: req.decoded._id}, { $set: properties}, { upsert: true, new: true })
