...
app.group("/user", (Route) => {
  // Route.get("/", authCtrl.authenticate, userCtrl.me);Route.post("/signup", userReq.signup, userReq.validate, userCtrl.signup);
  Route.post("/login", userReq.signin, userReq.validate, userCtrl.login);
  Route.get("/",  userCtrl.test);
});
...
// //   Route.get("/category/:category", ProductCtrl.getAllByCategory);
...
// //   Route.get("/:id", CategoryCtrl.getOne);
// // });
